...
//     try {
//       const response = await fetch('https://cet-titz.onrender.com/api/categories');
...
//           fetch(`https://cet-titz.onrender.com/api/categories/${id}`, { method: 'DELETE' })
//         )
//       );
...
//     try {
//       const response = await fetch(`https://cet-titz.onrender.com/api/categories/${id}`, { method: 'DELETE' });
//       if (response.ok) {
...
//     try {
//       const url = isEditing
//         ? `https://cet-titz.onrender.com/api/categories/${editingCategoryId}`
//         : 'https://cet-titz.onrender.com/api/categories';
